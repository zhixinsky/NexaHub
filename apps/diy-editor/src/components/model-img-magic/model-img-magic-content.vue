            ...
            <card-container class="card-container">
                ...
                <template v-if="!isEmpty(form.img_magic_list[selected_active])">
                    ...
                    <el-form-item label="链接">
                        <link-picker v-model="form.img_magic_list[selected_active].nexa_link" />
                    </el-form-item>
                </template>
            </card-container>
        </el-form>
...
import LinkPicker from '@/components/common/link-picker/LinkPicker.vue';
...
const style_show_list = [
    [{ start: {x: 1, y: 1}, end: {x: 4, y: 2}, img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} } }, { start: {x: 1, y: 3},end: {x: 4, y: 4},img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} }}], // 风格1
    [{ start: {x: 1, y: 1}, end: {x: 2, y: 4}, img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} } }, { start: {x: 3, y: 1},end: {x: 4, y: 4},img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} }}], // 风格2
    [{ start: {x: 1, y: 1}, end: {x: 2, y: 4}, img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} } }, { start: {x: 3, y: 1},end: {x: 4, y: 4},img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} }}, { start: {x: 3, y: 1},end: {x: 4, y: 4},img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} }}],// 风格3
    [{ start: {x: 1, y: 1}, end: {x: 2, y: 2}, img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} } }, { start: {x: 3, y: 1},end: {x: 4, y: 2},img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} }}, { start: {x: 1, y: 3},end: {x: 4, y: 4},img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} }}],// 风格4
    [{ start: {x: 1, y: 1}, end: {x: 4, y: 2}, img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} } }, { start: {x: 1, y: 3},end: {x: 2, y: 4},img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} }}, { start: {x: 3, y: 3},end: {x: 4, y: 4},img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} }}],// 风格5
    [{ start: {x: 1, y: 1}, end: {x: 2, y: 4}, img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} } }, { start: {x: 3, y: 1},end: {x: 4, y: 2},img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} }}, { start: {x: 3, y: 3},end: {x: 4, y: 4},img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} }}],// 风格6
    [{ start: {x: 1, y: 1}, end: {x: 2, y: 2}, img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} } }, { start: {x: 1, y: 3},end: {x: 2, y: 4},img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} }}, { start: {x: 3, y: 1},end: {x: 4, y: 4},img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} }}],// 风格7
    [{ start: {x: 1, y: 1}, end: {x: 2, y: 2}, img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} } }, { start: {x: 3, y: 1},end: {x: 4, y: 2},img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} }}, { start: {x: 1, y: 3},end: {x: 2, y: 4},img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} }}, { start: {x: 3, y: 3},end: {x: 4, y: 4},img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} }}],// 风格8
    [{ start: {x: 1, y: 1}, end: {x: 2, y: 4}, img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} } }, { start: {x: 3, y: 1},end: {x: 4, y: 2},img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} }}, { start: {x: 3, y: 3},end: {x: 3, y: 4},img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} }}, { start: {x: 4, y: 3},end: {x: 4, y: 4},img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} }}, { start: {x: 4, y: 3},end: {x: 4, y: 4},img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} }}],// 风格9
    [{ start: {x: 1, y: 1}, end: {x: 2, y: 4}, img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} } }, { start: {x: 3, y: 1},end: {x: 4, y: 2},img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} }}, { start: {x: 3, y: 3},end: {x: 3, y: 4},img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} }}, { start: {x: 4, y: 3},end: {x: 4, y: 4},img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} }}],// 风格10
    [{ start: {x: 1, y: 1}, end: {x: 4, y: 4}, img: [], img_link: {}, nexa_link: { type: 'none', label: '', params: {} } }],// 风格11
    []// 风格12
]
//#region 容器大小变更
...
const selected_click = (index: number) => {
    ...
    const cell = form.value.img_magic_list[index];
    if (cell && (cell.nexa_link == null || typeof cell.nexa_link !== 'object')) {
        cell.nexa_link = { type: 'none', label: '', params: {} };
    }
};
</script>
